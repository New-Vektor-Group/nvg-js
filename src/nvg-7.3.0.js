...
xCounter.forEach(function(ee){
      ...
      allImages[ee].onload = function()
      {
        if(isCss==0)
          ...
          $(allImagesOld[ee]).css({"background-image":"url('"+allImages[ee].src+"') !important"});
      };
  ...
  img.src = imageSrc;
      ...
      img.onload = function()
      {
        if(isCss==0)
          ...
          $(x).css({"background-image":"url('"+allImages[ee].src+"') !important"});
      };
}
...
static isVisible(elem, oft = 0, ofb = 0, ofl = 0, ofr = 0)
{
  var ika = 0;
